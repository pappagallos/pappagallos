...
===========================================
스페이스X 의 크루 드래곤 우주선의 컨트롤러는 HTML과 자바스크립트로만 이용해 웹 앱으로 구현했다고 합니다. 문명이 가진 최고 기술의 집약체인 우주선, 그 우주선의 컨트롤러 역할을 하는 웹 앱을 터치 스크린안에 넣어 개발했다고 하니 정말 흥분되는 일이었습니다. 저는 그만큼 프론트엔드가 적용될 수 있는 분야가 무궁무진하다고 믿습니다.
...
5. Mouse Colony Management, 실험용 마우스 관리 플랫폼 개발(2022.04~오픈 준비) | Next12 | 토이 프로젝트
