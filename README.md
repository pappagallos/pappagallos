...
Antibody, Biological & Chemical Reagents, Cell Culture, Commercial Software, Equipment & Instruments 등의 실험에 필요한 장비, 물품, 시약 등을 주문, 배송, 재고관리 등을 통합하여 관리해주는 'CareLab' 오픈소스를 기획하고 있어요.
...
4. 착한 성분 피부지상주의 천연 기능성 화장품, ISOI(아이소이) 프론트엔드 개발(2021.07~) | React17, Next11(함수형)
