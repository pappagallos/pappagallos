...
===========================================
지금은 주로 React.js 로 프론트엔드를 개발하고 있고 Vue.js 로도 A부터 Z까지 개발해본 경험이 있습니다. 아직도 모르는게 많고 배울 것들이 쌓여 계속 기술블로그들을 보며 공부하고 있습니다. 항상 <내일은 오늘과는 다르게> 마음 가짐으로 내일이 오면 더 성장해있는 프론트엔드 개발자라고 자신할 수 있습니다.
